...
<script type="text/javascript">
	function toGame(id, name, info, link, img, w, h) {
		...
		popUp.innerHTML = "<div style=\"height:250px; overflow:auto;\">"
				...
				+ "<tr><button class=\"button white\" onclick=\"removefromFavorites("
				+ id + ");\">Remove from Favorites</tr></td></table></div>";
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="<c:url value='/UserAccount'/>">
						My Account</a></li>
	...
	<div align="center">
		<table class="my_table_list">
			<tr>
				<td align="center"><h1 class="homeHeadLine">Favorites</h1></td>
			</tr>
