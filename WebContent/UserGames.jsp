	...
	function addToFavorites(id) {
		...
		$.ajax({
			...
			success : function(data) {
				if (data == "success") {
					//alert("This game has been successfully added to your favorites!");
					hidePopup();
					popup("success");
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="<c:url value='/UserGames'/>">Games</a></li>
	...
	<div align="center">
		<table class="my_table_list">
			<tr>
				<td align="center"><h1 class="homeHeadLine">Game
						Collections</h1></td>
			</tr>
